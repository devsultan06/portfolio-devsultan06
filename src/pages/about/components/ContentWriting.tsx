...
const ContentWriting = () => {
    return (
        <div className="h-[667px] overflow-y-auto custom-scrollbar px-[40px] text-slate400 text-[18px] font-[450] pt-[12px] pb-[100px] leading-[32px]">
            ...
            <p className="mb-[10px]"><span className="mr-[40px]">4</span> <span></span>   * I believe good writing sharpens clarity. It helps me structure thoughts better and explain technical ideas in a way others can understand.</p>
            <p className="mb-[10px]"><span className="mr-[40px]">5</span>   <span></span>* Soon, I’ll be publishing content that blends storytelling with tech — sharing not just how I code, but why.</p>
