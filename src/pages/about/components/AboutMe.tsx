const AboutMe = () => {
    return (
        <div className="h-[663px] max-1300:h-fit max-1300:overflow-hidden overflow-y-auto custom-scrollbar px-[40px] text-slate400 text-[18px] font-[450] pt-[12px] pb-[100px] leading-[32px]">
